...
namespace Mettle
{
    ...
    public partial class AssertImpl
    {
        ...
        public IAssert Equal(
            ...
            Memory<char> actualMemory) =>
                this.Equal((ReadOnlyMemory<char>)expectedMemory, (ReadOnlyMemory<char>)actualMemory, false, false, false);
        ...
        public IAssert Equal(
            Memory<char> expectedMemory,
            ReadOnlyMemory<char> actualMemory) =>
                this.Equal((ReadOnlyMemory<char>)expectedMemory, actualMemory, false, false, false);
        ...
        public IAssert Equal(
            ...
            Memory<char> actualMemory) =>
                this.Equal(expectedMemory, (ReadOnlyMemory<char>)actualMemory, false, false, false);
        ...
        public IAssert Equal(
            ReadOnlyMemory<char> expectedMemory,
            ReadOnlyMemory<char> actualMemory) =>
                this.Equal(expectedMemory, actualMemory, false, false, false);
        ...
        public IAssert Equal(
            ...
            bool ignoreWhiteSpaceDifferences = false) =>
                this.Equal((ReadOnlyMemory<char>)expectedMemory, (ReadOnlyMemory<char>)actualMemory, ignoreCase, ignoreLineEndingDifferences, ignoreWhiteSpaceDifferences);
        ...
        public IAssert Equal(
            ...
            bool ignoreLineEndingDifferences = false,
            bool ignoreWhiteSpaceDifferences = false) =>
                this.Equal((ReadOnlyMemory<char>)expectedMemory, actualMemory, ignoreCase, ignoreLineEndingDifferences, ignoreWhiteSpaceDifferences);
        ...
        public IAssert Equal(
            ...
            bool ignoreLineEndingDifferences = false,
            bool ignoreWhiteSpaceDifferences = false) =>
                this.Equal(expectedMemory, (ReadOnlyMemory<char>)actualMemory, ignoreCase, ignoreLineEndingDifferences, ignoreWhiteSpaceDifferences);
