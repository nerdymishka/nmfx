...
{
    public class MettleTestClassRunner : XunitTestClassRunner
    {
                ...
                collectionFixtureMappings)
        {
            ...
            var localServiceProvider = MettleServiceProviderLocator.GetServiceProvider(testClass);
        ...
        {
            if (this.serviceProvider?.GetService(typeof(ITestOutputHelperContainer))
        ...
        protected override bool TryGetConstructorArgument(ConstructorInfo constructor, int index, ParameterInfo parameter, out object? argumentValue)
        {
            ...
            if (!this.TryGetConstructorArgument(constructor, index, parameter, out argumentValue))
            {
        ...
        {
            return new MettleTestMethodRunner(
